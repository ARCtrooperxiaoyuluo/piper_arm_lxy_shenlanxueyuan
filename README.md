...
### 创建虚拟环境并安装依赖
```bash
$ conda create -n env_act python=3.10.9
$ conda activate env_act
...
--dataset.repo_id=group2/pick_and_place \
...
--robot.cameras="{wrist: {type: opencv, index_or_path: 4, width: 640, height: 480, fps: 30},top: {type: opencv, index_or_path: 10, width: 640, height: 480, fps: 30}}" \
--policy.type=act \
--ckpt_path=/home/ubuntu/VLA/result/checkpoints/120000/pretrained_model \
--task="Pick and place"
